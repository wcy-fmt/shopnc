...
$lang['admin_pointprod_unavailable']	 		= '系统未开启购物点中心，是否自动开启';
...
$lang['pointprod_help1']					= '使用购物点兑换功能请先确保系统购物点状态处于开启状态（运营 -> 基本设置），礼品会出现在购物点中心，会员可凭购物点兑换，兑换成功后，由系统平台进行发货。';
$lang['admin_pointprod_goods_points']		= '兑换购物点';
...
$lang['admin_pointprod_add_goodspoint_null_error']	= '请添加兑换购物点';
$lang['admin_pointprod_add_goodspoint_number_error']	= '兑换购物点为整数且大于等于0';
