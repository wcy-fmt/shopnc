...
$lang['admin_voucher_unavailable']    = '需开启 代金券、购物点，正在跳转到设置页面 。。。';
...
$lang['admin_voucher_price_points_error']   = '默认兑换购物点数应为大于0的整数';
$lang['admin_voucher_price_exist']    		= '该代金券面额已经存在';
$lang['admin_voucher_price_title']    		= '代金券面额';
$lang['admin_voucher_price_describe']    	= '描述';
$lang['admin_voucher_price_points']    		= '兑换购物点数';
$lang['admin_voucher_price_points_tip']    	= '当兑换代金券时，消耗的购物点数';
...
$lang['admin_voucher_apply_list_tip2']    	= '当卖家金币不足时审核会失败，卖家发布成功的代金券会出现在购物点中心，买家可凭购物点进行兑换';
 ...
 * 代金券
 */
$lang['admin_voucher_template_points_error']	= '兑换所需购物点数应为大于0的整数';
...
$lang['admin_voucher_template_points']			= '兑换所需购物点数';
