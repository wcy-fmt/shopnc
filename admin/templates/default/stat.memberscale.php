    ...
    <tbody>
      ...
      <tr>
        ...
        <ul>
            ...
            <li>列表展示了会员在搜索时间段内的有效订单总金额、预存款和购物点增减情况，并可以点击列表上方的“导出Excel”将列表数据导出为Excel文件</li>
  ...
  <table class="table tb-type2 nobdb">
    <thead>
      <tr class="thead sortbar-array">
        ...
        <th class="align-center"><a nc_type="orderitem" data-param='{"orderby":"pointsincrease"}' class="<?php echo ($output['orderby']=='pointsincrease desc')?'selected desc':''; echo $output['orderby']=='pointsincrease asc'?'selected asc':''; ?>">增购物点<i></i></a></th>
        <th class="align-center"><a nc_type="orderitem" data-param='{"orderby":"pointsreduce"}' class="<?php echo ($output['orderby']=='pointsreduce desc')?'selected desc':''; echo $output['orderby']=='pointsreduce asc'?'selected asc':''; ?>">减购物点<i></i></a></th>
      </tr>
    </thead>
    <tbody id="datatable">
