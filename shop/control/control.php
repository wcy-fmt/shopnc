    ...
    private function _getMenuList() {
        $menu_list = array(
                'trade' => array('name' => '交易管理', 'child' => array(
                        ...
                        'member_points'     => array('name' => '我的购物点', 'url'=>urlShop('member_points', 'index')),
//                        'member_voucher'    => array('name' => '返佣', 'url'=>urlShop('member_voucher', 'index'))
                        'member_voucher'    => array('name' => '返佣', 'url'=>urlShop('member_commission', 'index'))
                )),
...
class BasePointShopControl extends Control {
    ...
    /**
     * 获得购物点中心会员信息包括会员名、ID、会员头像、会员等级、经验值、等级进度、购物点、已领代金券、已兑换礼品、礼品购物车
     */
