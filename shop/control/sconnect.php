...
class sconnectControl extends BaseHomeControl{
	...
	public function registerOp(){
		...
		array("input"=>$_POST["province"],			"require"=>"false", 		"message"=>'请选择所在省'),
		array("input"=>$_POST["city"],			"require"=>"false", 		"message"=>'请选择所在市'),
		array("input"=>$_POST["area"],			"require"=>"false", 		"message"=>'请选择所在区')
		);
		...
		$user_array['reg_province']		= $_POST['province'];
		$user_array['reg_city']		= $_POST['city'];
		$user_array['reg_area']		= $_POST['area'];
