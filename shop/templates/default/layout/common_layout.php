    ...
    if (!empty($config['wap_site_url'])) {
        ...
        switch ($_GET['act']) {
            ...
            case 'show_store':
                ...
                break;
            case 'login':
                $url .= '/tmpl/member/register.html?store_id=' . $_GET['store_id'];
                break;
        }
    } else {
        $url = $config['site_url'];
...
<![endif]-->
    ...
    <script src="<?php echo RESOURCE_SITE_URL; ?>/js/lodash.min.js"></script>
...
<?php if (loadadv(1047)) { ?>
    ...
    <DIV id=homeTopAd01 style=" position:absolute; left:50%; margin:0 0 0 -600px; ">
        ...
        <div style=" position:absolute; z-index:1; top:5px; right:5px; "><a style="CURSOR: hand"
                                                                            onClick="homeTopAd()"><img
                        src="<?php echo SHOP_TEMPLATES_URL; ?>/images/close.png" width="24" height="24"/></a></div>
    </DIV>
...
<div class="header-wrap">
    <header class="public-head-layout wrapper">
        ...
        <?php //echo UPLOAD_SITE_URL.DS.ATTACH_COMMON.DS.C('mobile_app');?><!--" ></div>-->
        <!--        <div class="hint">-->
        <!--          <h4>扫描二维码</h4>-->
        <!--          下载手机客户端</div>-->
        <!--        <div class="addurl">-->
        <!--            --><?php //if (C('mobile_apk')){?>
        <!--            <a href="-->
        <?php //echo C('mobile_apk');?><!--" target="_blank"><i class="icon-android"></i>Android</a>-->
        <!--            --><?php //} ?>
        <!--            --><?php //if (C('mobile_ios')){?>
        <!--            <a href="-->
        <?php //echo C('mobile_ios');?><!--" target="_blank"><i class="icon-apple"></i>iPhone</a>-->
        <!--            --><?php //} ?>
        <!--            </div>-->
        <!--      </div>-->
        <!--    </div>-->
                    ...
                    <div class="user-centent-menu">
                        <ul>
                            ...
                            <?php if (C('points_isuse') == 1) { ?>
                                <li><a href="<?php echo SHOP_SITE_URL; ?>/index.php?act=member_points" class="arrow">我的购物点<i></i></a>
                                </li>
                            <?php } ?>
                        </ul>
                    </div>
