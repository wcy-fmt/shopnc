      ...
      <dl class="searchbox">
        ...
        <dd>
          <ul>
            ...
            <li class="selected" nc_type="search_orderby" data-param='{"orderval":"pointsasc"}'>购物点值<em class="desc"></em></li>
            <?php } elseif ($_GET['orderby'] == 'pointsasc') {//升序选中 ?>
            <li class="selected" nc_type="search_orderby" data-param='{"orderval":"pointsdesc"}'>购物点值<em class="asc"></em></li>
            <?php } else {//未选中?>
            <li nc_type="search_orderby" data-param='{"orderval":"pointsdesc"}'>购物点值<em class="desc"></em></li>
            <?php } ?>
            <!-- 购物点值e -->
            <li>&nbsp;</li>
            <!-- 面额s -->
    ...
    <ul class="ncp-voucher-list">
      ...
      <li>
        <div class="ncp-voucher">
          ...
          <div class="point">
            <p class="required">需<em><?php echo $v['voucher_t_points'];?></em>购物点</p>
