    ...
    <div class="nc-login-content">
      ...
      <?php Security::getToken();?>
        ...
        <dl>
          ...
          <dl>
              <dt><?php echo $lang['login_register_location'];?></dt>
              <dd style="min-height:54px;">
                  <div id="region"><select></select></div>
...
$(function(){
    ...
    $('#Submit').click(function(){
       $('#province').val($('select[class="valid"]').eq(0).val());
       if($('#province').val()=='-请选择-'){
           $('#province').val('');
       }

       $('#city').val($('select[class="valid"]').eq(1).val());
        if($('#city').val()=='-请选择-'){
            $('#city').val('');
        }

       $('#area').val($('select[class="valid"]').eq(2).val());
        if($('#area').val()=='-请选择-'){
            $('#area').val('');
        }
