...
<div class="ncc-receipt-info">
    ...
    <table class="ncc-table-style">
        ...
        <tbody>
        <tr>
            <th colspan="20"><strong>店铺：<a
                            href="<?php echo urlShop('show_store', 'index', array('store_id' => $store_id)); ?>"><?php echo $cart_list[0]['store_name']; ?></a></strong>
                    ...
                    <?php if (!empty($output['store_mansong_rule_list'][$store_id])) { ?>
                        ...
                        <?php if (is_array($output['store_premiums_list'][$store_id])) { ?>
                            <?php foreach ($output['store_premiums_list'][$store_id] as $goods_info) { ?>
                                <a href="<?php echo urlShop('goods', 'index', array('goods_id' => $goods_info['goods_id'])); ?>"
                                   target="_blank" class="ncc-store-gift"
                                   title="<?php echo $goods_info['goods_name']; ?>"><img
                                            src="<?php echo cthumb($goods_info['goods_image'], 60, $store_id); ?>"
                                            alt="<?php echo $goods_info['goods_name']; ?>"/></a>
                            <?php } ?>
                        <?php } ?>
                    <?php } ?>
                </div>
            ...
            <tr id="cart_item_<?php echo $cart_info['cart_id']; ?>"
                ...
                <?php if ($cart_info['bl_id'] == '0') { ?>
                    <td class="w60"><a
                                ...
                                target="_blank" class="ncc-goods-thumb"><img src="<?php echo thumb($cart_info, 60); ?>"
                ...
                <td class="tl" <?php if ($cart_info['bl_id'] != '0') { ?>colspan="2"<?php } ?>>
                    <dl class="ncc-goods-info">
                        ...
                        <?php } ?>
                        <?php if ($cart_info['bl_id'] != '0') { ?>
                            <dd><span class="buldling">优惠套装，单套直降<em>￥<?php echo $cart_info['down_price']; ?></em></span>
                            </dd>
                        <?php } ?>
                    ...
                    <tr class="shop-list <?php echo $cart_info['state'] && $cart_info['storage_state'] ? '' : 'item_disabled'; ?>">
                        ...
                        <td class="tl">
                            <dl class="ncc-goods-info">
                                <dt>
                                    <a href="<?php echo urlShop('goods', 'index', array('goods_id' => $goods_info['goods_id'])); ?>"
                                       target="_blank"><?php echo $goods_info['goods_name']; ?></a></dt>
                            </dl>
                        </td>
        ...
        <tr>
            <td class="tr" colspan="20">
                <div class="ncc-store-account">
                    <?php if($output['use_points']==1) {?>
                    <dl class="freight">
                        <dt>使用购物点：</dt>
                        <dd>
                            <em id="usePoints_<?php echo $store_id; ?>">9000</em>
                        </dd>
                    </dl>
                    <?php } ?>
                    <dl class="freight">
                        <dt>运费：</dt>
                        <dd>
                            <em id="eachStoreFreight_<?php echo $store_id; ?>">0.00</em><?php echo $lang['currency_zh']; ?>
                        </dd>
                    </dl>
                    <dl>
                        <dt>商品金额：</dt>
                        <dd>
                            <em id="eachStoreGoodsTotal_<?php echo $store_id; ?>"><?php echo $output['store_goods_total'][$store_id]; ?></em><?php echo $lang['currency_zh']; ?>
                        </dd>
                    </dl>
                    ...
                    <dl style="display: none;">
                        <dt>平台返佣金额：</dt>
                        <dd>
                            <em id="eachStoreGoodsCommisTotal_<?php echo $store_id; ?>"><?php echo $output['store_goods_commis_total'][$store_id]; ?></em><?php echo $lang['currency_zh']; ?>
                        </dd>
                    </dl>
                    ...
                    <?php if (!empty($output['store_mansong_rule_list'][$store_id]['discount'])) { ?>
                        <dl class="mansong">
                            ...
                            <dd>
                                <em id="eachStoreManSong_<?php echo $store_id; ?>">-<?php echo $output['store_mansong_rule_list'][$store_id]['discount']; ?></em><?php echo $lang['currency_zh']; ?>
                            </dd>
                        </dl>
                    <?php } ?>
                    ...
                    <dl class="total">
                        <dt>本店合计：</dt>
                        <dd><em store_id="<?php echo $store_id; ?>"
                ...
                <td class="pd-account" colspan="20">
                    <div class="ncc-pd-account">
                        ...
                        <div id="pd_password" style="display: none">支付密码：
                            <input type="password" class="text w120" value="" name="password" id="pay-password"
                            ...
                            <?php if (!$output['member_paypwd']) { ?>
                                还未设置支付密码，<a
                                        href="<?php echo SHOP_SITE_URL; ?>/index.php?act=member_security&op=auth&type=modify_paypwd"
        ...
        <tr>
            <td colspan="20">
                <div class="ncc-all-account">订单总金额：<em id="orderTotal"></em><?php echo $lang['currency_zh']; ?></div>
            </td>
        </tr>
        </tfoot>
    </table>
