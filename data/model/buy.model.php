...
class buyModel {
    ...
    public function buyStep2($post, $member_id, $member_name, $member_email) {
        ...
        //商品金额计算(分别对每个商品/优惠套装小计、每个店铺小计)
        list($store_cart_list,$store_goods_total,$store_goods_commis_total) = $model_cart->calcCartList($store_cart_list);
        ...
        $input['store_goods_commis_total'] = $store_goods_commis_total;
