...
class memberModel extends Model
{
    ...
    public function register($register_info)
    {
        ...
        $obj_validate->validateparam = array(
            ...
            array("input" => $register_info["province"], "require" => "false", "message" => '请选择所在省'),
            array("input" => $register_info["city"], "require" => "false", "message" => '请选择所在市'),
            array("input" => $register_info["area"], "require" => "false", "message" => '请选择所在区')
        );
        ...
        $member_info['reg_province'] = $register_info['province'];
        $member_info['reg_city'] = $register_info['city'];
        $member_info['reg_area'] = $register_info['area'];

        //添加邀请人(推荐人)会员购物点 by abc.com
		...
		if($member_info['inviter_id']){
            ...
            //http://www.seanwang66.com/mdd/api/register.php?MemberSN=sss&RecommendSN=sss&Time=1529888098&Key=4542bc4bb0502c7f9d658ecf92841e24

            $postData = 'MemberSN='.$insert_id.'&RecommendSN='.$member_info['inviter_id'].'&Time='.time().'&Key='.md5($insert_id.'MDD');

            $ch = curl_init(APT_GETWAY.'register.php');
    ...
    public function addMember($param)
    {
        ...
        try {
            ...
            // 注册时选择所在地区
            $member_info['reg_province'] = $param['reg_province'];
            $member_info['reg_city'] = $param['reg_city'];
            $member_info['reg_area'] = $param['reg_area'];
